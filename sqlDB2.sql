...
ALTER TABLE buyTBL add CONSTRAINT buyTBL_userTBL_userid_fk FOREIGN KEY (userID) REFERENCES userTBL(userID) 
ON DELETE CASCADE;
...
SELECT * FROM USERTBL U FULL OUTER JOIN BUYTBL B ON U.USERID = B.USERID;
